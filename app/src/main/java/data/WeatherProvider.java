...
public class WeatherProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            // "weather"
            case WEATHER: {
                retCursor = getWeather(uri, projection);
                break;
            }
            // "location"
            case LOCATION: {
                retCursor = getLocation(uri, projection);
                break;
            }
    ...
    private Cursor getLocation(Uri uri, String[] projection) {
    ...
    private Cursor getWeather(Uri uri, String[] projection) {
        return mOpenHelper.getReadableDatabase().query(
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case WEATHER:
                ...
                break;
            case LOCATION:
                rowsDeleted = writableDatabase.delete(WeatherContract.LocationEntry.TABLE_NAME, selection, selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
    ...
    public int update(
        ...
        switch (match) {
            case WEATHER:
                ...
                break;
            case LOCATION:
                rowsUpdated = writableDatabase.update(WeatherContract.LocationEntry.TABLE_NAME, values, selection, selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
